...
namespace Stack.Test
{
    ...
    public partial class StackContractTest
    {
        ...
        public void PUT_PushContract([PexAssumeUnderTest]Stack.Stack<int> s1, int x)
        {
            ...
            PexAssert.IsTrue(((New_s1ContainsX) && (New_x == Old_x) && (New_s1Count == 1 + Old_s1Count) && (New_Top == New_x) && (Old_s1ContainsX)) || ((New_s1ContainsX) && (New_x == Old_x) && (New_s1Count == 1 + Old_s1Count) && (New_Top == New_x) && ( ! (Old_Top == New_x))));
        }
        ...
        public void PUT_PopContract([PexAssumeUnderTest]Stack.Stack<int> s1)
        {
            ...
            PexAssert.IsTrue(((Old_s1Count == New_ret) && ( ! (New_s1Count == Old_s1Count)) && (Old_s1Count == Old_ret)) || (( ! (Old_s1Count == Old_ret)) && ( ! (Old_s1Count == New_ret))));
