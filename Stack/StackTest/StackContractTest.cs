...
namespace Stack.Test
{
    ...
    public partial class StackContractTest
    {
        ...
        public void PUT_PushContract([PexAssumeUnderTest]Stack.Stack<int> s1, int x)
        {
            ...
            PexAssert.IsTrue((New_s1ContainsX && New_s1Count == Old_s1Count + 1 && New_Top == Old_x && New_x == Old_x && New_s1Count != Old_s1Count && Old_x == New_Top && New_x == New_Top));
        ...
        public void PUT_PopContract([PexAssumeUnderTest]Stack.Stack<int> s1)
        {
            ...
            PexAssert.IsTrue((New_s1Count == Old_s1Count - 1 && New_Ret == Old_Top && New_s1Count != Old_s1Count));
        }
