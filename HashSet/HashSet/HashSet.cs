        ...
        */
        ...
        public class HashSet<T> : ICollection<T>, ISet<T>/*, IReadOnlyCollection<T>, ISerializable, IDeserializationCallback*/
        {
            ...
            */
            ...
            private void CopyFrom(HashSet<T> source)
            {
                ...
                int threshold = Common.Utility.HashHelpers.ExpandPrime(count + 1);
            ...
            /*public virtual void OnDeserialization(Object sender)
        {
            ...
            public int EnsureCapacity(int capacity)
            {
                ...
                int newSize = Common.Utility.HashHelpers.GetPrime(capacity);
                SetCapacity(newSize);
                return newSize;
            }
            ...
            public void TrimExcess()
            {
                ...
                else
                {
                    ...
                    int newSize = Common.Utility.HashHelpers.GetPrime(_count);
            ...
            private int Initialize(int capacity)
            {
                ...
                int size = Common.Utility.HashHelpers.GetPrime(capacity);
            ...
            private void IncreaseCapacity()
            {
                ...
                int newSize = Common.Utility.HashHelpers.ExpandPrime(_count);
                if (newSize <= _count)
                {
