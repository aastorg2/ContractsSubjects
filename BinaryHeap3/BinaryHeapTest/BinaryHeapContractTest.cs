...
namespace BinaryHeap.Test
{
    ...
    public partial class BinaryHeapContractTest
    {
        ...
        public void PUT_RemoveMinimumContract([PexAssumeUnderTest]BinaryHeap.BinaryHeap<int, int> bh)
        {
            ...
            Assert.True(((New_bhCount == -1 + Old_bhCount && Old_bhMinimumKey <= New_Ret_Key && New_Ret_Key <= Old_bhMinimumKey && New_Ret_Value <= Old_bhMinimumValue && Old_bhMinimumValue <= New_Ret_Value && New_bhCount >= 0 && New_bhMinimumValue >= 0)));
        }
