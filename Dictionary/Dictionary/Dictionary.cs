...
namespace Dictionary
{
    ...
    public class Dictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>, ISerializable/*, IDeserializationCallback*/
    {
        ...
        [DebuggerDisplay("Count = {Count}")]
        [Serializable]
        public sealed class KeyCollection : ICollection<TKey>, ICollection, Common.Utility.IReadOnlyCollection<TKey>
        {
            private Dictionary<TKey, TValue> dictionary;
        ...
        [DebuggerDisplay("Count = {Count}")]
        [Serializable]
        public sealed class ValueCollection : ICollection<TValue>, ICollection, Common.Utility.IReadOnlyCollection<TValue>
        {
            private Dictionary<TKey, TValue> dictionary;
