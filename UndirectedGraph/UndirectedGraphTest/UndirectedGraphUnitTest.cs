...
//            Assert.True(g.EdgeCount == 3 && g.VertexCount == 3);
//        }
...
//            g.AddVertex(1);
//            g.AddEdge(new Edge<int>(1, 1));
//            Assert.True(g.ContainsEdge(1, 1));
//        }
...
//            g.AddVertex(1);
//            //g.AddEdge(new Edge<int>(1, 1));
//            Assert.True(g.ContainsEdge(2, 1));
//        }
//        [TestMethod]
...
//            g.AddVertex(2);
//            g.AddEdge(new Edge<int>(1, 2));
//            Assert.True(g.ContainsEdge(new Edge<int>(1,2)));
//        }
