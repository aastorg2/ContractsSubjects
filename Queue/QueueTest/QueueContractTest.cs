...
namespace Queue.Test
{
    ...
    public partial class QueueContractTest
    {
        ...
        public void PUT_EnqueueContract([PexAssumeUnderTest]Queue.Queue<int> s1, int x)
        {
            ...
            Assert.True(((New_s1ContainsX && New_s1Count == Old_s1Count + 1 && New_x == Old_x && New_s1Count != Old_s1Count) && (((New_Top == 0 && New_x == 0 && Old_Top != New_s1Count && New_Top != New_s1Count && Old_x != New_s1Count && New_x != New_s1Count && New_Top == Old_Top && Old_x == Old_Top && Old_x == New_Top && New_x == New_Top) && New_x == Old_Top) || (((!(Old_s1ContainsX)) && Old_x != Old_Top && New_x != Old_Top) && (!(New_x == Old_Top))))));
        }
