...
namespace Queue.Test
{
    ...
    public partial class QueueContractTest
    {
        ...
        public void PUT_EnqueueContract([PexAssumeUnderTest]Queue.Queue<int> s1, int x)
        {
            ...
            PexAssert.IsTrue(((New_s1ContainsX) && (New_x == Old_x) && (New_s1Count == 1 + Old_s1Count) && (New_Top == Old_Top) && (Old_s1ContainsX)) || ((New_s1ContainsX) && (New_x == Old_x) && (New_s1Count == 1 + Old_s1Count) && (New_Top == Old_Top) && ( ! (New_Top == New_x))));
        }
        ...
        public void PUT_PeekContract([PexAssumeUnderTest]Queue.Queue<int> s1)
        {
            ...
            PexAssert.IsTrue(((New_s1Count == Old_s1Count) && (New_Top == Old_Top) && (New_Ret == Old_Top)));
        }
