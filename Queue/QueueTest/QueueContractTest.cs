...
namespace Queue.Test
{
    ...
    public partial class QueueContractTest
    {
        ...
        public void PUT_EnqueueContract([PexAssumeUnderTest]Queue.Queue<int> s1, int x)
        {
            ...
            PexAssert.IsTrue(((New_s1ContainsX && New_s1Count == Old_s1Count + 1 && New_x == Old_x && New_s1Count != Old_s1Count) && (((New_Top == 0 && New_x == 0 && Old_Top != New_s1Count && New_Top != New_s1Count && Old_x != New_s1Count && New_x != New_s1Count && New_Top == Old_Top && Old_x == Old_Top && Old_x == New_Top && New_x == New_Top) && New_x == Old_Top) || (((!(Old_s1ContainsX)) && Old_x != Old_Top && New_x != Old_Top) && (!(New_x == Old_Top))))));
        }
        ...
        public void PUT_PeekContract([PexAssumeUnderTest]Queue.Queue<int> s1)
        {
            ...
            PexAssert.IsTrue((New_s1Count == Old_s1Count && New_Top == Old_Top && New_Ret == Old_Top && New_Ret == New_Top));
        }
        ...
        public void PUT_CountContract([PexAssumeUnderTest]Queue.Queue<int> s1)
        {
            ...
            PexAssert.IsTrue((New_s1Count == Old_s1Count && New_Top == Old_Top && New_Ret == Old_s1Count && New_Ret == New_s1Count));
        }
        [PexMethod]
        public void PUT_ContainsContract([PexAssumeUnderTest]Queue.Queue<int> s1, int x)
        {
            ...
            PexAssert.IsTrue(((New_s1Count == Old_s1Count && New_Top == Old_Top) && ((((New_Ret && Old_s1ContainsX) && (((New_Top == Old_s1Count &&  Old_Top == Old_s1Count &&  Old_Top == New_s1Count) && New_Top == New_s1Count) || ((Old_Top != Old_s1Count &&  New_Top != Old_s1Count &&  Old_Top != New_s1Count &&  New_Top != New_s1Count) && (!(New_Top == New_s1Count))))) && New_s1ContainsX) || ((((!(New_Ret)) && (!(Old_s1ContainsX))) && (((New_Top == Old_s1Count &&  Old_Top == Old_s1Count &&  Old_Top == New_s1Count) && New_Top == New_s1Count) || ((Old_Top != Old_s1Count &&  New_Top != Old_s1Count &&  Old_Top != New_s1Count &&  New_Top != New_s1Count) && (!(New_Top == New_s1Count))))) && (!(New_s1ContainsX))))));
        }
