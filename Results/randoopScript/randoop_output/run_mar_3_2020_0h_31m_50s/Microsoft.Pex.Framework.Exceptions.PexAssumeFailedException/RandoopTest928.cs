...
public class RandoopTest928
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 926 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 927 transformer=array of System.Int32 of length 2 parents=[ 28 31 ], inputs=[ (0 0) (1 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 928 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 926 927 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
