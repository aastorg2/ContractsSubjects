...
public class RandoopTest1968
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v26,"Regression Failure? [267]");
      ...
      Dictionary.Dictionary<System.Int32, System.Int32> v38 = Dictionary.Test.Factories.DictionaryFactory.Create((System.Int32[])v36, (System.Int32[])v37) ;
      //Regression assertion (captures the current behavior of the code)
      Assert.IsNotNull(v38);

      System.Int32 v39 = (System.Int32)(-2);
      ((Dictionary.Test.DictionaryContractTest)v0).PUT_GetContract((Dictionary.Dictionary<System.Int32, System.Int32>)v38, (System.Int32)v39) ;
      /*
...
plan 1968 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_GetContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 410 1664 28 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
