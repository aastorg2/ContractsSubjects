...
public class RandoopTest4560
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 4558 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 4559 transformer=array of System.Int32 of length 2 parents=[ 28 34 ], inputs=[ (0 0) (1 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 4560 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 4558 4559 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
