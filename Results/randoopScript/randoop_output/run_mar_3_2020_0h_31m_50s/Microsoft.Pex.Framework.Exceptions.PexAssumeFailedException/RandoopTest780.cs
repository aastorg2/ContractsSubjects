...
public class RandoopTest780
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 777 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 778 transformer=array of System.Int32 of length 4 parents=[ 32 29 28 30 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 779 transformer=array of System.Int32 of length 1 parents=[ 26 ], inputs=[ (0 0) ]
plan 780 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 777 778 779 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
