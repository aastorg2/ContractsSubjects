...
public class RandoopTest2967
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v40,"Regression Failure? [463]");
...
plan 2967 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 1418 1741 27 25 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
