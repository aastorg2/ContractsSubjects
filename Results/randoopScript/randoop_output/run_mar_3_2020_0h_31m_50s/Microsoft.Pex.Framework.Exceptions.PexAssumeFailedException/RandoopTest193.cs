...
public class RandoopTest193
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 190 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 191 transformer=array of System.Int32 of length 1 parents=[ 31 ], inputs=[ (0 0) ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 192 transformer=array of System.Int32 of length 2 parents=[ 32 34 ], inputs=[ (0 0) (1 0) ]
plan 193 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 190 191 192 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
