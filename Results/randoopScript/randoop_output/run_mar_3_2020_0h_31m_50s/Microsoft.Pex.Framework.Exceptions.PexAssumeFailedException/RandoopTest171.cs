...
public class RandoopTest171
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 169 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 170 transformer=array of System.Int32 of length 4 parents=[ 31 33 31 27 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 171 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 169 170 34 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
