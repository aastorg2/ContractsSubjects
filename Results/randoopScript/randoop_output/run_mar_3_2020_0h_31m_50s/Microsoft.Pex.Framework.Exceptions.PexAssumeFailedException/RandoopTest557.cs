...
public class RandoopTest557
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 555 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 556 transformer=array of System.Int32 of length 3 parents=[ 34 25 27 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 557 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 555 556 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
