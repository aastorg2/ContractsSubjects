...
public class RandoopTest815
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 812 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 813 transformer=array of System.Int32 of length 1 parents=[ 27 ], inputs=[ (0 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 814 transformer=array of System.Int32 of length 4 parents=[ 26 26 32 26 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 815 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 812 813 814 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
