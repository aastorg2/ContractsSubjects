...
public class RandoopTest3251
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 3248 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 3249 transformer=array of System.Int32 of length 3 parents=[ 34 32 28 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 3250 transformer=array of System.Int32 of length 1 parents=[ 25 ], inputs=[ (0 0) ]
plan 3251 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 3248 3249 3250 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
