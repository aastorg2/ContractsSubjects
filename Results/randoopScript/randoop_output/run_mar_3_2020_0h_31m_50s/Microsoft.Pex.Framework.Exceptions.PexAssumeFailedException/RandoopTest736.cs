...
public class RandoopTest736
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 734 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 735 transformer=array of System.Int32 of length 4 parents=[ 33 26 26 25 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 736 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 734 735 31 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
