...
public class RandoopTest5698
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5696 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 5697 transformer=array of System.Int32 of length 2 parents=[ 31 27 ], inputs=[ (0 0) (1 0) ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 5698 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 5696 5697 25 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
