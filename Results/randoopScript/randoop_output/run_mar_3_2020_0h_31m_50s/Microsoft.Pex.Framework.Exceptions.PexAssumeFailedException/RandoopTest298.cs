...
public class RandoopTest298
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 295 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 296 transformer=array of System.Int32 of length 1 parents=[ 32 ], inputs=[ (0 0) ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 297 transformer=array of System.Int32 of length 3 parents=[ 31 32 32 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 298 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 295 296 297 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
