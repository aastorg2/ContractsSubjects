...
public class RandoopTest5137
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5135 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 5136 transformer=array of System.Int32 of length 1 parents=[ 33 ], inputs=[ (0 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 5137 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 5135 5136 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
