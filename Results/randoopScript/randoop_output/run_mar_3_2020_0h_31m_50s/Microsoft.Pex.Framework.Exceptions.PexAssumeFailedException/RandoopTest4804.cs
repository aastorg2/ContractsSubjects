...
public class RandoopTest4804
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 4802 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 4803 transformer=array of System.Int32 of length 4 parents=[ 31 26 31 34 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 4804 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 4802 4803 33 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
