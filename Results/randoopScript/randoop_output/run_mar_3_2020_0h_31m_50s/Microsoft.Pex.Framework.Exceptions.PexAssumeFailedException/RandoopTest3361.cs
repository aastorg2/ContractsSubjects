...
public class RandoopTest3361
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [544]");
      ...
      ((Dictionary.Test.DictionaryContractTest)v0).PUT_CountContract((Dictionary.Dictionary<System.Int32, System.Int32>)v37) ;
...
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 114 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 112 113 34 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 214 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_CountContract(Dictionary.Dictionary`2[System.Int32,System.Int32]) parents=[ 175 114 ], inputs=[ (0 0) (1 1) ]
...
plan 1611 transformer=Dictionary.Test.DictionaryContractTest.Void testFactorySize(Dictionary.Dictionary`2[System.Int32,System.Int32]) parents=[ 214 551 ], inputs=[ (0 0) (1 1) ]
...
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 3361 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAddingWithValueAlreadyInDict(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 1611 1931 28 28 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
