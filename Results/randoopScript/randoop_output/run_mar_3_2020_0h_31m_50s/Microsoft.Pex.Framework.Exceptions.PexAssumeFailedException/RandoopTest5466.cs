...
public class RandoopTest5466
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [988]");
      ...
      Dictionary.Dictionary<System.Int32, System.Int32> v61 = Dictionary.Test.Factories.DictionaryFactory.Create((System.Int32[])v55, (System.Int32[])v60) ;
      //Regression assertion (captures the current behavior of the code)
...
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 1765 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_ContainsKeyContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 1357 837 29 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 5466 transformer=Dictionary.Test.DictionaryContractTest.Void testValueSameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 1765 1931 33 30 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
