...
public class RandoopTest281
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 278 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 279 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 280 transformer=array of System.Int32 of length 1 parents=[ 27 ], inputs=[ (0 0) ]
plan 281 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 278 279 280 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
