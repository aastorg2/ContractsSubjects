...
public class RandoopTest1025
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1023 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 1024 transformer=array of System.Int32 of length 4 parents=[ 26 31 29 31 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 1025 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1023 1024 28 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
