...
public class RandoopTest4959
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v16,"Regression Failure? [888]");
...
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 4959 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAddingWithValueAlreadyInDict(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 2815 4209 30 25 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
