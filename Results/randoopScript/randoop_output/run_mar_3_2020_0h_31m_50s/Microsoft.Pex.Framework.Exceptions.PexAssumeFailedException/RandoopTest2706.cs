...
public class RandoopTest2706
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 2704 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 2705 transformer=array of System.Int32 of length 2 parents=[ 32 31 ], inputs=[ (0 0) (1 0) ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 2706 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 2704 2705 30 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
