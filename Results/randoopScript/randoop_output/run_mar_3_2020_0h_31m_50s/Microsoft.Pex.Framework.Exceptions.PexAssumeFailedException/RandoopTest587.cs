...
public class RandoopTest587
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 584 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 585 transformer=array of System.Int32 of length 4 parents=[ 25 34 25 29 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 586 transformer=array of System.Int32 of length 1 parents=[ 30 ], inputs=[ (0 0) ]
plan 587 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 584 585 586 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
