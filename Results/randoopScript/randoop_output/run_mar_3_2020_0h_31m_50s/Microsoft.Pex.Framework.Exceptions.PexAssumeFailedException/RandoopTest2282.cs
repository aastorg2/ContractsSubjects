...
public class RandoopTest2282
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 2280 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 2281 transformer=array of System.Int32 of length 1 parents=[ 27 ], inputs=[ (0 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 2282 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 2280 2281 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
