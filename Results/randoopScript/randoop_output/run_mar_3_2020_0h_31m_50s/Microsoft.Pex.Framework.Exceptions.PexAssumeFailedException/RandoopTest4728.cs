...
public class RandoopTest4728
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [816]");
      ...
      Dictionary.Dictionary<System.Int32, System.Int32> v47 = Dictionary.Test.Factories.DictionaryFactory.Create((System.Int32[])v45, (System.Int32[])v46) ;
      //Regression assertion (captures the current behavior of the code)
...
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 4728 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAddingWithValueAlreadyInDict(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 609 1664 32 27 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
