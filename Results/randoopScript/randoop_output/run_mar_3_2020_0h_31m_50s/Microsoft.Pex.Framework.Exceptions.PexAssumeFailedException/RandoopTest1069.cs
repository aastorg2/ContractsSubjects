...
public class RandoopTest1069
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1067 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 1068 transformer=array of System.Int32 of length 2 parents=[ 32 32 ], inputs=[ (0 0) (1 0) ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 1069 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1067 1068 33 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
