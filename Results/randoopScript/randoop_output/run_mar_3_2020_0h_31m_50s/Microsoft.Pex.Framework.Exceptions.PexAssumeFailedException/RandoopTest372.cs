...
public class RandoopTest372
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 369 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 370 transformer=array of System.Int32 of length 1 parents=[ 33 ], inputs=[ (0 0) ]
...
plan 371 transformer=array of System.Int32 of length 3 parents=[ 34 32 29 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 372 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 369 370 371 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
