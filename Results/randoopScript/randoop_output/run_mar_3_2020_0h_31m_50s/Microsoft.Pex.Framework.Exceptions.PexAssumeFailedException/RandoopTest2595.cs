...
public class RandoopTest2595
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [373]");
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v48,"Regression Failure? [374]");
      ...
      ((Dictionary.Test.DictionaryContractTest)v0).PUT_GetContract((Dictionary.Dictionary<System.Int32, System.Int32>)v67, (System.Int32)v68) ;
      /*
...
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 2595 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_GetContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 2211 2067 25 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
