...
public class RandoopTest3810
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [622]");
...
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 3810 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAddingWithValueAlreadyInDict(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 350 894 28 31 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
