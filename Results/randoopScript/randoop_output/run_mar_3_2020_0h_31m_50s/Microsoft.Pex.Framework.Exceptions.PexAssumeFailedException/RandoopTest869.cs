...
public class RandoopTest869
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 866 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 867 transformer=array of System.Int32 of length 1 parents=[ 28 ], inputs=[ (0 0) ]
plan 868 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 869 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 866 867 868 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
