...
public class RandoopTest5091
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5089 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 5090 transformer=array of System.Int32 of length 4 parents=[ 26 33 26 33 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 5091 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 5089 5090 28 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
