...
public class RandoopTest212
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 210 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 211 transformer=array of System.Int32 of length 2 parents=[ 31 28 ], inputs=[ (0 0) (1 0) ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 212 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 210 211 28 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
