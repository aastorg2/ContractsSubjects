...
public class RandoopTest926
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 923 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 924 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 925 transformer=array of System.Int32 of length 2 parents=[ 33 29 ], inputs=[ (0 0) (1 0) ]
plan 926 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 923 924 925 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
