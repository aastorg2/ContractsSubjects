...
public class RandoopTest713
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 710 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 711 transformer=array of System.Int32 of length 2 parents=[ 30 28 ], inputs=[ (0 0) (1 0) ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 712 transformer=array of System.Int32 of length 1 parents=[ 29 ], inputs=[ (0 0) ]
plan 713 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 710 711 712 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
