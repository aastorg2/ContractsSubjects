...
public class RandoopTest1655
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1653 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 1654 transformer=array of System.Int32 of length 4 parents=[ 26 32 30 27 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 1655 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1653 1654 28 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
