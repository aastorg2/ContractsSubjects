...
public class RandoopTest130
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 128 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 129 transformer=array of System.Int32 of length 4 parents=[ 31 31 30 25 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 130 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 128 129 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
