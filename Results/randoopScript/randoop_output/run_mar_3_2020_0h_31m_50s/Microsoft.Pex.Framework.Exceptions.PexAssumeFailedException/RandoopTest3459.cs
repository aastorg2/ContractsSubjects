...
public class RandoopTest3459
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 3457 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 3458 transformer=array of System.Int32 of length 3 parents=[ 25 28 33 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 3459 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 3457 3458 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
