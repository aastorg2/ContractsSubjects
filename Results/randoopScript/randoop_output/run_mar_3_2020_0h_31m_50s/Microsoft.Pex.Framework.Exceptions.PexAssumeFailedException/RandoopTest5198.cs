...
public class RandoopTest5198
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5196 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 5197 transformer=array of System.Int32 of length 3 parents=[ 28 29 26 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 5198 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 5196 5197 27 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
