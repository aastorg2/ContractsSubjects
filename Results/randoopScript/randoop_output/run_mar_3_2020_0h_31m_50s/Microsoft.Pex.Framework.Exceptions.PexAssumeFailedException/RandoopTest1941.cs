...
public class RandoopTest1941
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1939 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 1940 transformer=array of System.Int32 of length 3 parents=[ 31 31 28 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 1941 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1939 1940 27 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
