...
public class RandoopTest429
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 427 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 428 transformer=array of System.Int32 of length 4 parents=[ 30 25 30 31 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 429 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 427 428 34 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
