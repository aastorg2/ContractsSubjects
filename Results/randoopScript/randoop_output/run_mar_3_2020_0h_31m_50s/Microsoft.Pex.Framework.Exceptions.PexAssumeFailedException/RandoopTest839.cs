...
public class RandoopTest839
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 836 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 837 transformer=array of System.Int32 of length 1 parents=[ 25 ], inputs=[ (0 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 838 transformer=array of System.Int32 of length 2 parents=[ 26 30 ], inputs=[ (0 0) (1 0) ]
plan 839 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 836 837 838 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
