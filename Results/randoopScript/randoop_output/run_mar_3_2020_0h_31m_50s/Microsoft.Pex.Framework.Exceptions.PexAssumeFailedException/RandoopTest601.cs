...
public class RandoopTest601
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 599 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 600 transformer=array of System.Int32 of length 3 parents=[ 27 27 30 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 601 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 599 600 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
