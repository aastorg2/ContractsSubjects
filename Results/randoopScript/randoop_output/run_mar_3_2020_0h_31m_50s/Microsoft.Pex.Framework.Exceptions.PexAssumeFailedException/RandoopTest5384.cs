...
public class RandoopTest5384
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [967]");
      ...
      ((Dictionary.Test.DictionaryContractTest)v0).PUT_RemoveContract((Dictionary.Dictionary<System.Int32, System.Int32>)v39, (System.Int32)v40) ;
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v49,"Regression Failure? [968]");
...
plan 1735 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_RemoveContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 175 837 32 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 2916 transformer=Dictionary.Test.DictionaryContractTest.Boolean testFactoryContains(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 1735 1796 29 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 5384 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_GetContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 2916 1672 31 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
