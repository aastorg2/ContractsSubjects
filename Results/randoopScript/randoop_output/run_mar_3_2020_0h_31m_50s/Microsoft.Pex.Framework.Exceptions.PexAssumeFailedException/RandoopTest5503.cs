...
public class RandoopTest5503
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5501 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 5502 transformer=array of System.Int32 of length 2 parents=[ 32 34 ], inputs=[ (0 0) (1 0) ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 5503 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 5501 5502 27 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
