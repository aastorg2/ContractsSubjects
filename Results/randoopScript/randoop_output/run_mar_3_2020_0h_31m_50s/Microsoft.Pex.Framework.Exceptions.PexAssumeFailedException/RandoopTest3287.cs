...
public class RandoopTest3287
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 3285 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 3286 transformer=array of System.Int32 of length 4 parents=[ 30 31 31 31 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 3287 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 3285 3286 32 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
