...
public class RandoopTest5225
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [938]");
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v33,"Regression Failure? [939]");
      ...
      ((Dictionary.Test.DictionaryContractTest)v0).testKeySameAsCountAfterAdding((Dictionary.Dictionary<System.Int32, System.Int32>)v53, (System.Int32)v54, (System.Int32)v55) ;
      ...
      ((Dictionary.Test.DictionaryContractTest)v0).testKeySameAsCountAfterAdding((Dictionary.Dictionary<System.Int32, System.Int32>)v63, (System.Int32)v64, (System.Int32)v65) ;
      /*
...
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 1533 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 538 669 31 29 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
plan 4752 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 4753 transformer=array of System.Int32 of length 3 parents=[ 32 29 26 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 4754 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 4752 4753 34 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 5225 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 1533 4754 30 25 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
