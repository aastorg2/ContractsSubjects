...
public class RandoopTest5866
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [1067]");
      ...
      System.Int32[] v67 =  new System.Int32[] {v63 , v64 , v65 , v66};
...
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 5866 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAddingWithValueAlreadyInDict(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 1097 2451 34 28 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
