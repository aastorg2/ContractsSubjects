...
public class RandoopTest1875
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1872 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 1873 transformer=array of System.Int32 of length 1 parents=[ 28 ], inputs=[ (0 0) ]
...
plan 1874 transformer=array of System.Int32 of length 4 parents=[ 26 32 27 29 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 1875 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 1872 1873 1874 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
