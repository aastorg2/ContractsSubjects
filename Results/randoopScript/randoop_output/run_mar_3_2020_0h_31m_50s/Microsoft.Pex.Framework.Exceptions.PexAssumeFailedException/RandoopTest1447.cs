...
public class RandoopTest1447
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1444 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 1445 transformer=array of System.Int32 of length 2 parents=[ 34 32 ], inputs=[ (0 0) (1 0) ]
plan 1446 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 1447 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 1444 1445 1446 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
