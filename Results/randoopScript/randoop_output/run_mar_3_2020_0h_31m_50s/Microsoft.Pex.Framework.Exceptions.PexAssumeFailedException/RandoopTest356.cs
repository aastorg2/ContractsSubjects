...
public class RandoopTest356
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 354 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 355 transformer=array of System.Int32 of length 3 parents=[ 30 27 28 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 356 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 354 355 28 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
