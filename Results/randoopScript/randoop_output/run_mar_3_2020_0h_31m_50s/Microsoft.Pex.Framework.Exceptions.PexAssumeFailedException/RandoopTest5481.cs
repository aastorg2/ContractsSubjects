...
public class RandoopTest5481
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v16,"Regression Failure? [992]");
...
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 5481 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 175 669 28 28 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
