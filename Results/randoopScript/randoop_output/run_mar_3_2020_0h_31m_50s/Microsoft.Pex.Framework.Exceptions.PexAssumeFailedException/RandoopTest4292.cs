...
public class RandoopTest4292
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v16,"Regression Failure? [717]");
      ...
      ((Dictionary.Test.DictionaryContractTest)v0).PUT_GetContract((Dictionary.Dictionary<System.Int32, System.Int32>)v59, (System.Int32)v60) ;
      /*
...
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 4292 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_GetContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 499 346 33 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
