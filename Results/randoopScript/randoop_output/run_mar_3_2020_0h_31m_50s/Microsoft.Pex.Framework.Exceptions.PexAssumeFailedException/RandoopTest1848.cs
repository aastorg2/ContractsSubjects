...
public class RandoopTest1848
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1846 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 1847 transformer=array of System.Int32 of length 3 parents=[ 26 26 34 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 1848 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1846 1847 32 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
