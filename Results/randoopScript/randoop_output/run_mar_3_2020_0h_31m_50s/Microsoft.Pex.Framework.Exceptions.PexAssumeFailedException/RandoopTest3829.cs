...
public class RandoopTest3829
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 3827 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 3828 transformer=array of System.Int32 of length 3 parents=[ 31 30 31 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 3829 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 3827 3828 31 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
