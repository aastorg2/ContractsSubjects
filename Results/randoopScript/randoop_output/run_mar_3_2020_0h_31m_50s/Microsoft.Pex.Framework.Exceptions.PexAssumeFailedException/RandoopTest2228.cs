...
public class RandoopTest2228
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 2226 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 2227 transformer=array of System.Int32 of length 3 parents=[ 26 34 34 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 2228 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 2226 2227 30 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
