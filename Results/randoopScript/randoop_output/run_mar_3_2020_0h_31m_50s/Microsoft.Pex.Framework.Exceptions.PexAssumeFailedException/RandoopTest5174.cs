...
public class RandoopTest5174
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5172 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 5173 transformer=array of System.Int32 of length 2 parents=[ 27 25 ], inputs=[ (0 0) (1 0) ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 5174 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 5172 5173 30 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
