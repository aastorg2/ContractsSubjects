...
public class RandoopTest5444
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5441 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 5442 transformer=array of System.Int32 of length 1 parents=[ 27 ], inputs=[ (0 0) ]
plan 5443 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 5444 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 5441 5442 5443 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
