...
public class RandoopTest1146
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1144 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 1145 transformer=array of System.Int32 of length 4 parents=[ 34 32 32 33 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 1146 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1144 1145 28 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
