...
public class RandoopTest793
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 790 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 791 transformer=array of System.Int32 of length 2 parents=[ 26 26 ], inputs=[ (0 0) (1 0) ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 792 transformer=array of System.Int32 of length 1 parents=[ 31 ], inputs=[ (0 0) ]
plan 793 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 790 791 792 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
