...
public class RandoopTest3577
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 3574 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 3575 transformer=array of System.Int32 of length 2 parents=[ 31 25 ], inputs=[ (0 0) (1 0) ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 3576 transformer=array of System.Int32 of length 1 parents=[ 33 ], inputs=[ (0 0) ]
plan 3577 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 3574 3575 3576 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
