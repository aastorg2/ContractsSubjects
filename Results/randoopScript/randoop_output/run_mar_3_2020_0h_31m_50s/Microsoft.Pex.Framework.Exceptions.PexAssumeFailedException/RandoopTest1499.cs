...
public class RandoopTest1499
{
  public static int Main()
  {
    try
    {
      ...
      Dictionary.Dictionary<System.Int32, System.Int32> v3 = Dictionary.Test.Factories.DictionaryFactory.createDictionaryArrays((System.Int32[])v1, (System.Int32)v2) ;
      //Regression assertion (captures the current behavior of the code)
      Assert.IsNotNull(v3);

      /*
      plan 1497 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 1498 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 1499 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1497 1498 28 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
