...
public class RandoopTest5107
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5104 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 5105 transformer=array of System.Int32 of length 2 parents=[ 33 25 ], inputs=[ (0 0) (1 0) ]
plan 5106 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 5107 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 5104 5105 5106 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
