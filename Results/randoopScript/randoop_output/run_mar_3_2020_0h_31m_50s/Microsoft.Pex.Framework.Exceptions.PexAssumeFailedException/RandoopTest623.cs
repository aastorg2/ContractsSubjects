...
public class RandoopTest623
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 621 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 622 transformer=array of System.Int32 of length 4 parents=[ 26 25 32 30 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 623 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 621 622 32 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
