...
public class RandoopTest1852
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v26,"Regression Failure? [243]");
      ...
      ((Dictionary.Test.DictionaryContractTest)v0).PUT_ContainsKeyContract((Dictionary.Dictionary<System.Int32, System.Int32>)v55, (System.Int32)v56) ;
...
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 1396 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_ContainsKeyContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 455 225 27 ], inputs=[ (0 0) (1 1) (2 0) ]
plan 223 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 224 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 225 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 223 224 33 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 1852 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAddingWithValueAlreadyInDict(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 1396 225 33 33 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
