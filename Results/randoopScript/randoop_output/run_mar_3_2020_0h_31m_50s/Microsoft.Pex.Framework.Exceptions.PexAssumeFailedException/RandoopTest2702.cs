...
public class RandoopTest2702
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 2700 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 2701 transformer=array of System.Int32 of length 1 parents=[ 29 ], inputs=[ (0 0) ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 2702 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 2700 2701 27 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
