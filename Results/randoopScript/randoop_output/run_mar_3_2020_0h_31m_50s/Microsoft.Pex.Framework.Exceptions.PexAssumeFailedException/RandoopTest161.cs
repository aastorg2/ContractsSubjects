...
public class RandoopTest161
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 158 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 159 transformer=array of System.Int32 of length 2 parents=[ 25 33 ], inputs=[ (0 0) (1 0) ]
plan 160 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 161 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 158 159 160 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
