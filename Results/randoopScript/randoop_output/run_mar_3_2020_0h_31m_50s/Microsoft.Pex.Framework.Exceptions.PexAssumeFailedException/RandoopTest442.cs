...
public class RandoopTest442
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 440 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 441 transformer=array of System.Int32 of length 3 parents=[ 29 32 30 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 442 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 440 441 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
