...
public class RandoopTest497
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 495 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 496 transformer=array of System.Int32 of length 1 parents=[ 34 ], inputs=[ (0 0) ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 497 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 495 496 29 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
