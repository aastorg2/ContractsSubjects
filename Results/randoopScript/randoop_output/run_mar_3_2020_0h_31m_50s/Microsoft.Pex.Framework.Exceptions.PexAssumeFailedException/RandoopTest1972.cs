...
public class RandoopTest1972
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1970 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 1971 transformer=array of System.Int32 of length 3 parents=[ 26 31 33 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 1972 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1970 1971 25 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
