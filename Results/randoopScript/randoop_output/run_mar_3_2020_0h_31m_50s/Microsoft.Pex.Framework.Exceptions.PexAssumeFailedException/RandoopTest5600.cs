...
public class RandoopTest5600
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5598 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 5599 transformer=array of System.Int32 of length 3 parents=[ 29 33 33 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 5600 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 5598 5599 31 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
