...
public class RandoopTest1727
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1724 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 1725 transformer=array of System.Int32 of length 1 parents=[ 28 ], inputs=[ (0 0) ]
...
plan 1726 transformer=array of System.Int32 of length 3 parents=[ 32 33 25 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 1727 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 1724 1725 1726 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
