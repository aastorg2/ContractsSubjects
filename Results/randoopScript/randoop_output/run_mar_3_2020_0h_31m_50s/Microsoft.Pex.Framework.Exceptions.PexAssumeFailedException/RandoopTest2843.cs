...
public class RandoopTest2843
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v16,"Regression Failure? [431]");
      ...
      ((Dictionary.Test.DictionaryContractTest)v0).PUT_ContainsValueContract((Dictionary.Dictionary<System.Int32, System.Int32>)v45, (System.Int32)v46) ;
...
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 1262 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_SetContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 1258 979 31 29 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
...
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 2427 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_ContainsValueContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 1262 1741 27 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 2843 transformer=Dictionary.Test.DictionaryContractTest.Void testValueSameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 2427 2129 33 26 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
