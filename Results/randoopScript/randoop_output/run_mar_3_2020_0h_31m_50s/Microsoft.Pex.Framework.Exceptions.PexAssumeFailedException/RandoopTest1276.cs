...
public class RandoopTest1276
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1274 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 1275 transformer=array of System.Int32 of length 2 parents=[ 31 27 ], inputs=[ (0 0) (1 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 1276 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1274 1275 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
