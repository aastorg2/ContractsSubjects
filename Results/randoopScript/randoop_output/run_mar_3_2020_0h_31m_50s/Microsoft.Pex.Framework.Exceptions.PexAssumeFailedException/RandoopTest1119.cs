...
public class RandoopTest1119
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1117 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 1118 transformer=array of System.Int32 of length 2 parents=[ 32 31 ], inputs=[ (0 0) (1 0) ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 1119 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1117 1118 25 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
