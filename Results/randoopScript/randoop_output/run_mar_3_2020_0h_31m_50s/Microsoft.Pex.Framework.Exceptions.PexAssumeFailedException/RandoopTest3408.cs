...
public class RandoopTest3408
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 3406 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 3407 transformer=array of System.Int32 of length 2 parents=[ 27 33 ], inputs=[ (0 0) (1 0) ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 3408 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 3406 3407 30 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
