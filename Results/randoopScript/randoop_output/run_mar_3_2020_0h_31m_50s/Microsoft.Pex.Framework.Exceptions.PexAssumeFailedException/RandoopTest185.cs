...
public class RandoopTest185
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 182 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 183 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
...
plan 184 transformer=array of System.Int32 of length 3 parents=[ 29 26 27 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 185 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 182 183 184 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
