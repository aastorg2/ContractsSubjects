...
public class RandoopTest250
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 247 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 248 transformer=array of System.Int32 of length 4 parents=[ 34 26 31 28 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 249 transformer=array of System.Int32 of length 1 parents=[ 30 ], inputs=[ (0 0) ]
plan 250 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 247 248 249 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
