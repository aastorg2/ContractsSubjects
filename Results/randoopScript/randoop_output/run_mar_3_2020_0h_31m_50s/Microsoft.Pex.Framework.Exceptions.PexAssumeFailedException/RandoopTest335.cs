...
public class RandoopTest335
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 332 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 333 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 334 transformer=array of System.Int32 of length 3 parents=[ 26 31 26 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 335 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 332 333 334 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
