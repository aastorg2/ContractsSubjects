...
public class RandoopTest5902
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5899 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 5900 transformer=array of System.Int32 of length 3 parents=[ 26 27 34 ], inputs=[ (0 0) (1 0) (2 0) ]
...
plan 5901 transformer=array of System.Int32 of length 4 parents=[ 30 31 26 32 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 5902 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 5899 5900 5901 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
