...
public class RandoopTest907
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v37,"Regression Failure? [84]");
      ...
      ((Dictionary.Test.DictionaryContractTest)v0).PUT_GetContract((Dictionary.Dictionary<System.Int32, System.Int32>)v43, (System.Int32)v44) ;
      /*
...
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 907 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_GetContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 873 247 27 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
