...
public class RandoopTest5654
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5652 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 5653 transformer=array of System.Int32 of length 1 parents=[ 28 ], inputs=[ (0 0) ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 5654 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 5652 5653 28 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
