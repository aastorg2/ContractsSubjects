...
public class RandoopTest198
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 196 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 197 transformer=array of System.Int32 of length 2 parents=[ 28 27 ], inputs=[ (0 0) (1 0) ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 198 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 196 197 30 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
