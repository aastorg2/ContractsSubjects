...
public class RandoopTest485
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 483 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 484 transformer=array of System.Int32 of length 4 parents=[ 31 31 34 34 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 485 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 483 484 33 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
