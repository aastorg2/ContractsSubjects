...
public class RandoopTest1261
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1259 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 1260 transformer=array of System.Int32 of length 2 parents=[ 26 28 ], inputs=[ (0 0) (1 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 1261 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1259 1260 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
