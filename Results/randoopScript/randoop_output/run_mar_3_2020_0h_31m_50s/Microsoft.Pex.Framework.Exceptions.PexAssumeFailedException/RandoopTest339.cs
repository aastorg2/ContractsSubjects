...
public class RandoopTest339
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 337 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 338 transformer=array of System.Int32 of length 1 parents=[ 26 ], inputs=[ (0 0) ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 339 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 337 338 30 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
