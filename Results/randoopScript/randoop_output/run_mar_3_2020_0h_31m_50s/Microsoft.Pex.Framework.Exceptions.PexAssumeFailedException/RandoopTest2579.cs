...
public class RandoopTest2579
{
  public static int Main()
  {
    try
    {
      ...
      Dictionary.Dictionary<System.Int32, System.Int32> v4 = Dictionary.Test.Factories.DictionaryFactory.Create((System.Int32[])v1, (System.Int32[])v3) ;
      /*
      plan 2576 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 2577 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 2578 transformer=array of System.Int32 of length 1 parents=[ 34 ], inputs=[ (0 0) ]
plan 2579 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 2576 2577 2578 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
