...
public class RandoopTest2409
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 2407 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 2408 transformer=array of System.Int32 of length 3 parents=[ 30 32 29 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 2409 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 2407 2408 25 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
