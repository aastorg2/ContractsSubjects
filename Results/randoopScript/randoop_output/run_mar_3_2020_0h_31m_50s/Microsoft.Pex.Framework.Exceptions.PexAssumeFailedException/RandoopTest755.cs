...
public class RandoopTest755
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 752 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 753 transformer=array of System.Int32 of length 4 parents=[ 25 28 27 26 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 754 transformer=array of System.Int32 of length 1 parents=[ 32 ], inputs=[ (0 0) ]
plan 755 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 752 753 754 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
