...
public class RandoopTest628
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 625 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 626 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 627 transformer=array of System.Int32 of length 2 parents=[ 33 29 ], inputs=[ (0 0) (1 0) ]
plan 628 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 625 626 627 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
