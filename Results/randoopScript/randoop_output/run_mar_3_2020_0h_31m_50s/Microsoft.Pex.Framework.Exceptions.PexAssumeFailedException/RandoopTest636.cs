...
public class RandoopTest636
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v42,"Regression Failure? [22]");
      ...
      ((Dictionary.Test.DictionaryContractTest)v0).PUT_GetContract((Dictionary.Dictionary<System.Int32, System.Int32>)v49, (System.Int32)v50) ;
      /*
...
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 636 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_GetContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 423 602 27 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
