...
public class RandoopTest3635
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [592]");
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v65,"Regression Failure? [593]");
      ...
      System.Int32[] v78 =  new System.Int32[] {v77};
      Dictionary.Dictionary<System.Int32, System.Int32> v79 = Dictionary.Test.Factories.DictionaryFactory.Create((System.Int32[])v76, (System.Int32[])v78) ;
      //Regression assertion (captures the current behavior of the code)
      Assert.IsNotNull(v79);

      System.Int32 v80 = (System.Int32)10;
      ((Dictionary.Test.DictionaryContractTest)v0).PUT_GetContract((Dictionary.Dictionary<System.Int32, System.Int32>)v79, (System.Int32)v80) ;
      /*
...
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 1535 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_ContainsKeyContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 1292 247 30 ], inputs=[ (0 0) (1 1) (2 0) ]
plan 244 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 245 transformer=array of System.Int32 of length 1 parents=[ 29 ], inputs=[ (0 0) ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
...
plan 247 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 244 245 246 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 3635 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_GetContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 1535 247 34 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
