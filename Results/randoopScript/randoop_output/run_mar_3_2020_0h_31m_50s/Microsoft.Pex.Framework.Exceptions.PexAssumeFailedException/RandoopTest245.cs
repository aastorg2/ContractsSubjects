...
public class RandoopTest245
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 243 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 244 transformer=array of System.Int32 of length 2 parents=[ 26 32 ], inputs=[ (0 0) (1 0) ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 245 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 243 244 25 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
