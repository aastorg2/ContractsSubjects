...
public class RandoopTest1018
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1015 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 1016 transformer=array of System.Int32 of length 3 parents=[ 30 34 33 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 1017 transformer=array of System.Int32 of length 1 parents=[ 30 ], inputs=[ (0 0) ]
plan 1018 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 1015 1016 1017 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
