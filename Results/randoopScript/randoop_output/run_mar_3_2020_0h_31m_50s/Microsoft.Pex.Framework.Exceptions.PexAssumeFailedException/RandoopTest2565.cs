...
public class RandoopTest2565
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 2563 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 2564 transformer=array of System.Int32 of length 3 parents=[ 25 32 32 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 2565 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 2563 2564 25 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
