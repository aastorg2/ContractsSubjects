...
public class RandoopTest5181
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5178 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 5179 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 5180 transformer=array of System.Int32 of length 1 parents=[ 28 ], inputs=[ (0 0) ]
plan 5181 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 5178 5179 5180 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
