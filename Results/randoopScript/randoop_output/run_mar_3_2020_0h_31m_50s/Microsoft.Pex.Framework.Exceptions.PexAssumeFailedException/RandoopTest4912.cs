...
public class RandoopTest4912
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v33,"Regression Failure? [868]");
...
plan 4912 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 4149 3887 32 25 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
