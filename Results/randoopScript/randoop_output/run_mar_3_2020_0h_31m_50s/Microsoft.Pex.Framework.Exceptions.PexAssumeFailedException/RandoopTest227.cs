...
public class RandoopTest227
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 225 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 226 transformer=array of System.Int32 of length 4 parents=[ 26 27 32 31 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 227 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 225 226 29 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
