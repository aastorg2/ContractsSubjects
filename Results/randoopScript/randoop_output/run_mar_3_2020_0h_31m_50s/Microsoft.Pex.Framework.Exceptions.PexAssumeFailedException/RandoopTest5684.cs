...
public class RandoopTest5684
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [1021]");
      ...
      Dictionary.Dictionary<System.Int32, System.Int32> v66 = Dictionary.Test.Factories.DictionaryFactory.Create((System.Int32[])v62, (System.Int32[])v65) ;
      //Regression assertion (captures the current behavior of the code)
...
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 5684 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 2860 837 29 33 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
