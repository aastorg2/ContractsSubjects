...
public class RandoopTest1581
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1578 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 1579 transformer=array of System.Int32 of length 2 parents=[ 26 32 ], inputs=[ (0 0) (1 0) ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 1580 transformer=array of System.Int32 of length 1 parents=[ 30 ], inputs=[ (0 0) ]
plan 1581 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 1578 1579 1580 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
