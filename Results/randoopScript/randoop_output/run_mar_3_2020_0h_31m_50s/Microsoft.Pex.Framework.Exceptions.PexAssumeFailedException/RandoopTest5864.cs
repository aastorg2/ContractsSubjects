...
public class RandoopTest5864
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v16,"Regression Failure? [1065]");
...
plan 1357 transformer=Dictionary.Test.DictionaryContractTest.Void testFactorySize(Dictionary.Dictionary`2[System.Int32,System.Int32]) parents=[ 690 1110 ], inputs=[ (0 0) (1 1) ]
...
plan 5864 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_GetContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 1357 2993 33 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
