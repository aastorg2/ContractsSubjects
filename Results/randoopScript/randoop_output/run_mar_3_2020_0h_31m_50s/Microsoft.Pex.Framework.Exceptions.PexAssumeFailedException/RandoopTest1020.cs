...
public class RandoopTest1020
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [102]");
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v48,"Regression Failure? [103]");
      ...
      System.Boolean v57 = ((Dictionary.Test.DictionaryContractTest)v0).testFactoryContains((Dictionary.Dictionary<System.Int32, System.Int32>)v55, (System.Int32)v56) ;
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v57,"Regression Failure? [104]");
      ...
      ((Dictionary.Test.DictionaryContractTest)v0).testKeySameAsCountAfterAdding((Dictionary.Dictionary<System.Int32, System.Int32>)v68, (System.Int32)v69, (System.Int32)v70) ;
      /*
...
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 719 transformer=Dictionary.Test.DictionaryContractTest.Boolean testFactoryContains(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 274 615 32 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 810 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_RemoveContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 719 165 25 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 1020 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 810 551 27 33 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
