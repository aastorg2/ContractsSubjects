...
public class RandoopTest5079
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5077 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 5078 transformer=array of System.Int32 of length 2 parents=[ 29 30 ], inputs=[ (0 0) (1 0) ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 5079 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 5077 5078 30 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
