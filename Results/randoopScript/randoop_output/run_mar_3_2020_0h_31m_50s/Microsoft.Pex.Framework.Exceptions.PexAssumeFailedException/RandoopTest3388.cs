...
public class RandoopTest3388
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v16,"Regression Failure? [555]");
      ...
      ((Dictionary.Test.DictionaryContractTest)v0).testKeySameAsCountAfterAddingWithValueAlreadyInDict((Dictionary.Dictionary<System.Int32, System.Int32>)v56, (System.Int32)v57, (System.Int32)v58) ;
      /*
...
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 589 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_AddContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 272 225 25 31 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
...
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 3388 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAddingWithValueAlreadyInDict(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 589 894 25 25 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
