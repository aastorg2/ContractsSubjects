...
public class RandoopTest850
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v26,"Regression Failure? [75]");
      ...
      System.Int32[] v32 =  new System.Int32[] {v28 , v29 , v30 , v31};
...
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 850 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_AddContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 268 495 26 25 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
