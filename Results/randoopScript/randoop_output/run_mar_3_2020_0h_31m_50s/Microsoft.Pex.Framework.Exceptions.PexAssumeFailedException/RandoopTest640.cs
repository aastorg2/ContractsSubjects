...
public class RandoopTest640
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 638 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 639 transformer=array of System.Int32 of length 3 parents=[ 34 31 31 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 640 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 638 639 34 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
