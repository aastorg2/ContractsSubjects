...
public class RandoopTest4311
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 4309 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 4310 transformer=array of System.Int32 of length 3 parents=[ 26 28 25 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 4311 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 4309 4310 25 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
