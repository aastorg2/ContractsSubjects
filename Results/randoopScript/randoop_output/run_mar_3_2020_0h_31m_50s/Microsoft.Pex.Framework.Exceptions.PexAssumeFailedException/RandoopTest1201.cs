...
public class RandoopTest1201
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1199 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 1200 transformer=array of System.Int32 of length 2 parents=[ 26 27 ], inputs=[ (0 0) (1 0) ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 1201 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1199 1200 30 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
