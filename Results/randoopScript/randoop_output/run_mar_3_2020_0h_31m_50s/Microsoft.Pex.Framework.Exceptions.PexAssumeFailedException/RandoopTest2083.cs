...
public class RandoopTest2083
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 2080 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 2081 transformer=array of System.Int32 of length 1 parents=[ 25 ], inputs=[ (0 0) ]
...
plan 2082 transformer=array of System.Int32 of length 4 parents=[ 28 28 27 34 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 2083 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 2080 2081 2082 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
