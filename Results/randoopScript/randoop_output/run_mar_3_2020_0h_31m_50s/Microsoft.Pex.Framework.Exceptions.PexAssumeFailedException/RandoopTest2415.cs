...
public class RandoopTest2415
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [348]");
...
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 114 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 112 113 34 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 1286 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_CountContract(Dictionary.Dictionary`2[System.Int32,System.Int32]) parents=[ 249 114 ], inputs=[ (0 0) (1 1) ]
...
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 2415 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_GetContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 1286 1672 34 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
