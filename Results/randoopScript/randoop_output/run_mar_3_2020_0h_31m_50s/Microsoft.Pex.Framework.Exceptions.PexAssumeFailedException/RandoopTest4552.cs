...
public class RandoopTest4552
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 4549 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 4550 transformer=array of System.Int32 of length 1 parents=[ 31 ], inputs=[ (0 0) ]
...
plan 4551 transformer=array of System.Int32 of length 3 parents=[ 30 33 29 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 4552 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 4549 4550 4551 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
