...
public class RandoopTest2752
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 2750 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 2751 transformer=array of System.Int32 of length 2 parents=[ 27 33 ], inputs=[ (0 0) (1 0) ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 2752 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 2750 2751 25 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
