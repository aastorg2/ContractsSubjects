...
public class RandoopTest5862
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5860 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 5861 transformer=array of System.Int32 of length 3 parents=[ 30 30 29 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 5862 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 5860 5861 34 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
