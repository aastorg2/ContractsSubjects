...
public class RandoopTest1694
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1692 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 1693 transformer=array of System.Int32 of length 1 parents=[ 31 ], inputs=[ (0 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 1694 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1692 1693 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
