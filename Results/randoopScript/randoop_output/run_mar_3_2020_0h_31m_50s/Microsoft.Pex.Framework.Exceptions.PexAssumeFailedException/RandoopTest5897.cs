...
public class RandoopTest5897
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5895 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 5896 transformer=array of System.Int32 of length 3 parents=[ 27 30 27 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 5897 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 5895 5896 33 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
