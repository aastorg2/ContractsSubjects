//LAST ACTION: Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32)
//EXCEPTION: Microsoft.Pex.Framework.Exceptions.PexAssumeFailedException
using Dictionary.Test.Factories;
using System;
public class RandoopTest3823
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 3821 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 3822 transformer=array of System.Int32 of length 4 parents=[ 31 30 31 28 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 3823 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 3821 3822 30 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
