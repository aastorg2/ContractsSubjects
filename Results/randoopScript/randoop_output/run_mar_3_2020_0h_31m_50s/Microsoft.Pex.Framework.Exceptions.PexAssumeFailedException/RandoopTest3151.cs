...
public class RandoopTest3151
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [499]");
...
plan 390 transformer=Dictionary.Test.DictionaryContractTest.Void testFactorySize(Dictionary.Dictionary`2[System.Int32,System.Int32]) parents=[ 204 294 ], inputs=[ (0 0) (1 1) ]
...
plan 3151 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 390 1609 25 33 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
