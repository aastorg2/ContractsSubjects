...
public class RandoopTest3489
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 3487 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 3488 transformer=array of System.Int32 of length 3 parents=[ 27 34 33 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 3489 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 3487 3488 29 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
