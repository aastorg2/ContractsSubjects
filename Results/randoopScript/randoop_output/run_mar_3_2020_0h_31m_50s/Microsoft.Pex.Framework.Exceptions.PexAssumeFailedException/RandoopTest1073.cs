...
public class RandoopTest1073
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1071 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 1072 transformer=array of System.Int32 of length 2 parents=[ 30 30 ], inputs=[ (0 0) (1 0) ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 1073 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1071 1072 25 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
