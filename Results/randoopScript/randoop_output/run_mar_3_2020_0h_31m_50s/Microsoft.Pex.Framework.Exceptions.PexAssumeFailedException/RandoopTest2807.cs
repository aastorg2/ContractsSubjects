...
public class RandoopTest2807
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 2804 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 2805 transformer=array of System.Int32 of length 2 parents=[ 34 30 ], inputs=[ (0 0) (1 0) ]
plan 2806 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 2807 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 2804 2805 2806 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
