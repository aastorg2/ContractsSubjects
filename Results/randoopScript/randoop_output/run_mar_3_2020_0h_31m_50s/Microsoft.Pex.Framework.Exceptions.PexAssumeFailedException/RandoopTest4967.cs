...
public class RandoopTest4967
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 4965 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 4966 transformer=array of System.Int32 of length 4 parents=[ 30 25 32 27 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 4967 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 4965 4966 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
