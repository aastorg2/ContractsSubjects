...
public class RandoopTest5918
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v16,"Regression Failure? [1073]");
...
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 5918 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAddingWithValueAlreadyInDict(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 578 615 28 32 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
