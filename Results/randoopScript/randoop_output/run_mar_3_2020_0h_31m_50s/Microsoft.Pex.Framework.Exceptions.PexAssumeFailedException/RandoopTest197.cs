...
public class RandoopTest197
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 195 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 196 transformer=array of System.Int32 of length 3 parents=[ 25 28 29 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 197 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 195 196 25 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
