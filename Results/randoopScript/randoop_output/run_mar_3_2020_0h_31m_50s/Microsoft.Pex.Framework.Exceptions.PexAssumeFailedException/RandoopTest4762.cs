...
public class RandoopTest4762
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [825]");
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v48,"Regression Failure? [826]");
      ...
      ((Dictionary.Test.DictionaryContractTest)v0).testValueSameAsCountAfterAdding((Dictionary.Dictionary<System.Int32, System.Int32>)v54, (System.Int32)v55, (System.Int32)v56) ;
      /*
...
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 4762 transformer=Dictionary.Test.DictionaryContractTest.Void testValueSameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 274 905 31 29 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
