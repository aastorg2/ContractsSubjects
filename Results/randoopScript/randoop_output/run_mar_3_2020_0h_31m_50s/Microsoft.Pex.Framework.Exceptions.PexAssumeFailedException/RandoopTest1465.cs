...
public class RandoopTest1465
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1463 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 1464 transformer=array of System.Int32 of length 4 parents=[ 34 30 26 27 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 1465 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1463 1464 29 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
