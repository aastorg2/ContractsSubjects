...
public class RandoopTest4041
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 4038 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 4039 transformer=array of System.Int32 of length 1 parents=[ 30 ], inputs=[ (0 0) ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 4040 transformer=array of System.Int32 of length 2 parents=[ 32 25 ], inputs=[ (0 0) (1 0) ]
plan 4041 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 4038 4039 4040 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
