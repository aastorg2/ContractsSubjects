...
public class RandoopTest2135
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v26,"Regression Failure? [290]");
...
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 2135 transformer=Dictionary.Test.DictionaryContractTest.Void testValueSameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 410 114 29 33 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
