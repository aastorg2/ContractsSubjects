...
public class RandoopTest313
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v33,"Regression Failure? [1]");
...
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 313 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAddingWithValueAlreadyInDict(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 290 144 33 26 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
