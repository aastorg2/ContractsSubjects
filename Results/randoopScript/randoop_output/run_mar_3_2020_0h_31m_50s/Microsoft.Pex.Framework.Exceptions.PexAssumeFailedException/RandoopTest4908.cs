...
public class RandoopTest4908
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 4905 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 4906 transformer=array of System.Int32 of length 4 parents=[ 25 26 26 28 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 4907 transformer=array of System.Int32 of length 1 parents=[ 32 ], inputs=[ (0 0) ]
plan 4908 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 4905 4906 4907 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
