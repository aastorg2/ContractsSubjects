...
public class RandoopTest819
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 817 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 818 transformer=array of System.Int32 of length 3 parents=[ 29 29 25 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 819 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 817 818 31 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
