...
public class RandoopTest2384
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 2381 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 2382 transformer=array of System.Int32 of length 1 parents=[ 25 ], inputs=[ (0 0) ]
...
plan 2383 transformer=array of System.Int32 of length 3 parents=[ 28 29 33 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 2384 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 2381 2382 2383 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
