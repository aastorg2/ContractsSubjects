...
public class RandoopTest1363
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v9,"Regression Failure? [92]");
...
plan 414 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_RemoveContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 322 237 31 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 782 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_CountContract(Dictionary.Dictionary`2[System.Int32,System.Int32]) parents=[ 414 662 ], inputs=[ (0 0) (1 1) ]
...
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 1085 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_AddContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 782 504 27 27 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
...
plan 1363 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_GetContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 1085 845 28 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
