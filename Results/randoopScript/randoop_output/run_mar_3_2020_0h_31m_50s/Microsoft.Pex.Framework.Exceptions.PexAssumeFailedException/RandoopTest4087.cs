...
public class RandoopTest4087
{
  public static int Main()
  {
    try
    {
      ...
      ((Dictionary.Test.DictionaryContractTest)v0).testFactorySize((Dictionary.Dictionary<System.Int32, System.Int32>)v30) ;
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v40,"Regression Failure? [678]");
...
plan 1594 transformer=Dictionary.Test.DictionaryContractTest.Void testFactorySize(Dictionary.Dictionary`2[System.Int32,System.Int32]) parents=[ 489 1401 ], inputs=[ (0 0) (1 1) ]
...
plan 2155 transformer=Dictionary.Test.DictionaryContractTest.Boolean testFactoryContains(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 1594 1945 32 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 4087 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 2155 1931 33 30 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
