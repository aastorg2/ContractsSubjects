...
public class RandoopTest3627
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 3624 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 3625 transformer=array of System.Int32 of length 4 parents=[ 32 33 33 29 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 3626 transformer=array of System.Int32 of length 1 parents=[ 33 ], inputs=[ (0 0) ]
plan 3627 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 3624 3625 3626 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
