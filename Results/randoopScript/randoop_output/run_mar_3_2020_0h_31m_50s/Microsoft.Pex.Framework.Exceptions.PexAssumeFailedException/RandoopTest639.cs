...
public class RandoopTest639
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v9,"Regression Failure? [23]");
      ...
      ((Dictionary.Test.DictionaryContractTest)v0).PUT_GetContract((Dictionary.Dictionary<System.Int32, System.Int32>)v16, (System.Int32)v17) ;
      /*
...
plan 639 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_GetContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 322 602 25 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
