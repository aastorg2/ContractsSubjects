...
public class RandoopTest119
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 116 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 117 transformer=array of System.Int32 of length 1 parents=[ 25 ], inputs=[ (0 0) ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 118 transformer=array of System.Int32 of length 2 parents=[ 34 32 ], inputs=[ (0 0) (1 0) ]
plan 119 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 116 117 118 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
