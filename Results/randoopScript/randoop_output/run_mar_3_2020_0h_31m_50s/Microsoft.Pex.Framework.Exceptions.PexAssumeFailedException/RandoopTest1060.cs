...
public class RandoopTest1060
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1058 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 1059 transformer=array of System.Int32 of length 4 parents=[ 27 29 30 27 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 1060 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1058 1059 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
