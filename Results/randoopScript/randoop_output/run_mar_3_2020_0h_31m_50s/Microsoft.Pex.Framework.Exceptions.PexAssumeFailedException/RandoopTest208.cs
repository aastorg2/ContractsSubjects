...
public class RandoopTest208
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 206 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 207 transformer=array of System.Int32 of length 1 parents=[ 30 ], inputs=[ (0 0) ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 208 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 206 207 29 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
