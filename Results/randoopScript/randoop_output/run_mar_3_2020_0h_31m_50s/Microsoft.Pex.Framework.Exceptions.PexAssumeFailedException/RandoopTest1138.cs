...
public class RandoopTest1138
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1136 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 1137 transformer=array of System.Int32 of length 4 parents=[ 32 26 29 34 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 1138 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1136 1137 25 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
