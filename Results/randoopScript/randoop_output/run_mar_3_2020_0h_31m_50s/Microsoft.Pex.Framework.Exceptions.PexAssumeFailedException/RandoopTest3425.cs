...
public class RandoopTest3425
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 3422 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 3423 transformer=array of System.Int32 of length 3 parents=[ 34 31 32 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 3424 transformer=array of System.Int32 of length 1 parents=[ 26 ], inputs=[ (0 0) ]
plan 3425 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 3422 3423 3424 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
