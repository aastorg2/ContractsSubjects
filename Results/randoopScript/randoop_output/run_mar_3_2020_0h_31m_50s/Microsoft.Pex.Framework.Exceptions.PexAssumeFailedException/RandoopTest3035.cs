...
public class RandoopTest3035
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 3033 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 3034 transformer=array of System.Int32 of length 3 parents=[ 26 28 30 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 3035 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 3033 3034 25 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
