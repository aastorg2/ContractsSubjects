...
public class RandoopTest2629
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 2627 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 2628 transformer=array of System.Int32 of length 1 parents=[ 29 ], inputs=[ (0 0) ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 2629 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 2627 2628 25 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
