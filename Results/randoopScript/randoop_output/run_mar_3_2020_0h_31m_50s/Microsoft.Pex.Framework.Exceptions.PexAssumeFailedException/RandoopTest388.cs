...
public class RandoopTest388
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 386 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 387 transformer=array of System.Int32 of length 2 parents=[ 28 28 ], inputs=[ (0 0) (1 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 388 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 386 387 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
