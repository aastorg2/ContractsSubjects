...
public class RandoopTest1039
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1037 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 1038 transformer=array of System.Int32 of length 2 parents=[ 30 33 ], inputs=[ (0 0) (1 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 1039 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1037 1038 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
