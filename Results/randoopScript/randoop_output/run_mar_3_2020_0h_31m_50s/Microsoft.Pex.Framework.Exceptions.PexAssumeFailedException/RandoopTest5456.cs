...
public class RandoopTest5456
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5453 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 5454 transformer=array of System.Int32 of length 3 parents=[ 30 34 30 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 5455 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 5456 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 5453 5454 5455 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
