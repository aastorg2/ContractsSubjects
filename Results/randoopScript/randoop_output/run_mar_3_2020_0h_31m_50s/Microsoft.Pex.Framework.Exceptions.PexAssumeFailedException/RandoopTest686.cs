...
public class RandoopTest686
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 683 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 684 transformer=array of System.Int32 of length 2 parents=[ 34 31 ], inputs=[ (0 0) (1 0) ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 685 transformer=array of System.Int32 of length 1 parents=[ 32 ], inputs=[ (0 0) ]
plan 686 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 683 684 685 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
