...
public class RandoopTest2599
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v31,"Regression Failure? [376]");
...
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 2599 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_AddContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 921 294 32 31 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
