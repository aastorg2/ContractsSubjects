...
public class RandoopTest221
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 218 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 219 transformer=array of System.Int32 of length 4 parents=[ 26 25 29 34 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
...
plan 220 transformer=array of System.Int32 of length 3 parents=[ 28 33 31 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 221 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 218 219 220 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
