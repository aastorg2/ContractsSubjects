...
public class RandoopTest5475
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [989]");
      ...
      Dictionary.Dictionary<System.Int32, System.Int32> v63 = Dictionary.Test.Factories.DictionaryFactory.Create((System.Int32[])v57, (System.Int32[])v62) ;
      //Regression assertion (captures the current behavior of the code)
...
plan 1274 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_ContainsKeyContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 372 346 33 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 5475 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAddingWithValueAlreadyInDict(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 1274 1931 27 30 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
