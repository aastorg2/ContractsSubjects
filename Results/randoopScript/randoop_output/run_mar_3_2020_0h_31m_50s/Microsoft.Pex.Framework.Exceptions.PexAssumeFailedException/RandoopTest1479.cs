...
public class RandoopTest1479
{
  public static int Main()
  {
    try
    {
      ...
      System.Boolean v27 = ((Dictionary.Test.DictionaryContractTest)v0).testFactoryContains((Dictionary.Dictionary<System.Int32, System.Int32>)v25, (System.Int32)v26) ;
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v27,"Regression Failure? [184]");
...
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 1181 transformer=Dictionary.Test.DictionaryContractTest.Boolean testFactoryContains(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 644 247 28 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 1479 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_GetContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 1181 905 29 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
