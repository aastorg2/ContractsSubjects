...
public class RandoopTest1272
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1269 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 1270 transformer=array of System.Int32 of length 1 parents=[ 26 ], inputs=[ (0 0) ]
plan 1271 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 1272 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 1269 1270 1271 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
