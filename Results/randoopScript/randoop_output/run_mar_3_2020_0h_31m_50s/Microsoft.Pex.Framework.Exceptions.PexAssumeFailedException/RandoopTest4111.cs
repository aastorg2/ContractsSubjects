...
public class RandoopTest4111
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 4109 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 4110 transformer=array of System.Int32 of length 3 parents=[ 28 30 31 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 4111 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 4109 4110 30 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
