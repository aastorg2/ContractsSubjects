...
public class RandoopTest2508
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 2505 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 2506 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 2507 transformer=array of System.Int32 of length 1 parents=[ 33 ], inputs=[ (0 0) ]
plan 2508 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 2505 2506 2507 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
