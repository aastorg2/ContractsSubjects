...
public class RandoopTest3201
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 3199 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 3200 transformer=array of System.Int32 of length 1 parents=[ 34 ], inputs=[ (0 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 3201 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 3199 3200 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
