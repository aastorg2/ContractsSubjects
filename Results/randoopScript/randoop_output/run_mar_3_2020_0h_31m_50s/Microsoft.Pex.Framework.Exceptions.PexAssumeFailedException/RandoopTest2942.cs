...
public class RandoopTest2942
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 2939 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 2940 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 2941 transformer=array of System.Int32 of length 1 parents=[ 26 ], inputs=[ (0 0) ]
plan 2942 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 2939 2940 2941 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
