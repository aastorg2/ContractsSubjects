...
public class RandoopTest872
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 869 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 870 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 871 transformer=array of System.Int32 of length 2 parents=[ 30 34 ], inputs=[ (0 0) (1 0) ]
plan 872 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 869 870 871 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
