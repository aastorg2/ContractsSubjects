...
public class RandoopTest1132
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v30,"Regression Failure? [121]");
      ...
      ((Dictionary.Test.DictionaryContractTest)v0).testKeySameAsCountAfterAddingWithValueAlreadyInDict((Dictionary.Dictionary<System.Int32, System.Int32>)v36, (System.Int32)v37, (System.Int32)v38) ;
      /*
...
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 1132 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAddingWithValueAlreadyInDict(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 1024 247 25 32 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
