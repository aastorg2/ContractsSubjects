...
public class RandoopTest808
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 805 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 806 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
...
plan 807 transformer=array of System.Int32 of length 3 parents=[ 28 29 33 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 808 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 805 806 807 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
