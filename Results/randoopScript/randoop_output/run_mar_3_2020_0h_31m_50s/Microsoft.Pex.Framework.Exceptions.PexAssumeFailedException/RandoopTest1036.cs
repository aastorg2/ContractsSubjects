...
public class RandoopTest1036
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1034 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 1035 transformer=array of System.Int32 of length 2 parents=[ 33 25 ], inputs=[ (0 0) (1 0) ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 1036 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 1034 1035 26 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
