...
public class RandoopTest420
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 418 transformer=DummyTransformer parents=[ ], inputs=[ ]
...
plan 419 transformer=array of System.Int32 of length 4 parents=[ 31 26 26 33 ], inputs=[ (0 0) (1 0) (2 0) (3 0) ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 420 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 418 419 25 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
