...
public class RandoopTest2652
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 2649 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 27 transformer=(System.Int32)(-3) parents=[ ], inputs=[ ]
plan 2650 transformer=array of System.Int32 of length 2 parents=[ 33 27 ], inputs=[ (0 0) (1 0) ]
plan 2651 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 2652 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 2649 2650 2651 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
