...
public class RandoopTest175
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 173 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 174 transformer=array of System.Int32 of length 2 parents=[ 32 25 ], inputs=[ (0 0) (1 0) ]
plan 29 transformer=(System.Int32)(-1) parents=[ ], inputs=[ ]
plan 175 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 173 174 29 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
