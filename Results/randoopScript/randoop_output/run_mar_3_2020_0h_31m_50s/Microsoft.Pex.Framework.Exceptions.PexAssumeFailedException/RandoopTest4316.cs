...
public class RandoopTest4316
{
  public static int Main()
  {
    try
    {
      ...
      System.Boolean v31 = ((Dictionary.Test.DictionaryContractTest)v0).testFactoryContains((Dictionary.Dictionary<System.Int32, System.Int32>)v29, (System.Int32)v30) ;
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v31,"Regression Failure? [724]");
...
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 319 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_RemoveContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 136 225 34 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 2429 transformer=Dictionary.Test.DictionaryContractTest.Boolean testFactoryContains(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 319 2067 26 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 4316 transformer=Dictionary.Test.DictionaryContractTest.Void testValueSameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 2429 905 31 33 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
