...
public class RandoopTest5398
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5396 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 5397 transformer=array of System.Int32 of length 2 parents=[ 30 34 ], inputs=[ (0 0) (1 0) ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 5398 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 5396 5397 30 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
