...
public class RandoopTest5801
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 5798 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 5799 transformer=array of System.Int32 of length 2 parents=[ 32 31 ], inputs=[ (0 0) (1 0) ]
plan 5800 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 5801 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 5798 5799 5800 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
