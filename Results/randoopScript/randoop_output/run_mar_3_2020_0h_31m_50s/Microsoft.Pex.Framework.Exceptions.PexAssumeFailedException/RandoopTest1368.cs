...
public class RandoopTest1368
{
  public static int Main()
  {
    try
    {
      ...
      /*
      plan 1365 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 1366 transformer=array of System.Int32 of length 0 parents=[ ], inputs=[ ]
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 1367 transformer=array of System.Int32 of length 1 parents=[ 34 ], inputs=[ (0 0) ]
plan 1368 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 1365 1366 1367 ], inputs=[ (0 0) (1 0) (2 0) ]
      */
      //END TEST
