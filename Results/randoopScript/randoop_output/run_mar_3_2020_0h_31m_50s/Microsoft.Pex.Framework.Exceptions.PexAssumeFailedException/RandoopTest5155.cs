...
public class RandoopTest5155
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [924]");
      ...
      System.Int32[] v80 =  new System.Int32[] {v77 , v78 , v79};
...
plan 615 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] createDictionaryArrays(Int32[], Int32) parents=[ 613 614 33 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 5155 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_GetContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 1984 615 28 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
