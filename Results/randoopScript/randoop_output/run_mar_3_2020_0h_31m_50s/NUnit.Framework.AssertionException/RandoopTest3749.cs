...
public class RandoopTest3749
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v72,"Regression Failure? [610]");
...
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 3732 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 1158 3240 32 26 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
...
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 3749 transformer=Dictionary.Test.DictionaryContractTest.Boolean testFactoryContains(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 3732 247 31 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
