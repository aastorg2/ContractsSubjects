...
public class RandoopTest998
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v49,"Regression Failure? [98]");
...
plan 34 transformer=(System.Int32)10 parents=[ ], inputs=[ ]
plan 25 transformer=(System.Int32)(-10) parents=[ ], inputs=[ ]
plan 702 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_AddContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 467 247 34 25 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
...
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 998 transformer=Dictionary.Test.DictionaryContractTest.Boolean testFactoryContains(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 702 225 26 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
