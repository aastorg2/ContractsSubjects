...
public class RandoopTest4537
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [775]");
      ...
      System.Boolean v76 = ((Dictionary.Test.DictionaryContractTest)v0).testFactoryContains((Dictionary.Dictionary<System.Int32, System.Int32>)v74, (System.Int32)v75) ;
      /*
...
plan 1951 transformer=Dictionary.Test.DictionaryContractTest.Void testFactorySize(Dictionary.Dictionary`2[System.Int32,System.Int32]) parents=[ 1097 615 ], inputs=[ (0 0) (1 1) ]
...
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 4537 transformer=Dictionary.Test.DictionaryContractTest.Boolean testFactoryContains(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 1951 894 31 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
