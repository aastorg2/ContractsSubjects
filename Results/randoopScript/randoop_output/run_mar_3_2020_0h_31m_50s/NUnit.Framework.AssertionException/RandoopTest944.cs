...
public class RandoopTest944
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [88]");
...
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 944 transformer=Dictionary.Test.DictionaryContractTest.Boolean testFactoryContains(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 350 615 33 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
