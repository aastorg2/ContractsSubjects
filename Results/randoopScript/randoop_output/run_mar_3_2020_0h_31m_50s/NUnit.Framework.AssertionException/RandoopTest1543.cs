...
public class RandoopTest1543
{
  public static int Main()
  {
    try
    {
      ...
      System.Boolean v38 = ((Dictionary.Test.DictionaryContractTest)v0).testFactoryContains((Dictionary.Dictionary<System.Int32, System.Int32>)v36, (System.Int32)v37) ;
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v38,"Regression Failure? [196]");
...
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 1543 transformer=Dictionary.Test.DictionaryContractTest.Boolean testFactoryContains(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 1152 247 31 ], inputs=[ (0 0) (1 1) (2 0) ]
      */
      //END TEST
