...
public class RandoopTest1193
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(false, v30,"Regression Failure? [133]");
...
plan 1193 transformer=Dictionary.Test.DictionaryContractTest.Void testValueSameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 1032 346 25 33 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
