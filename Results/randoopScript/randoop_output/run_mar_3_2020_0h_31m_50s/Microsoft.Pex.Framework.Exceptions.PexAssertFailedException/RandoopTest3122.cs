...
public class RandoopTest3122
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v16,"Regression Failure? [494]");
...
plan 3122 transformer=Dictionary.Test.DictionaryContractTest.Void testValueSameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 188 2067 33 32 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
