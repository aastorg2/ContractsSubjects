...
public class RandoopTest1280
{
  public static int Main()
  {
    try
    {
      ...
      //Regression assertion (captures the current behavior of the code)
      Assert.AreEqual<System.Boolean>(true, v34,"Regression Failure? [82]");
...
plan 144 transformer=Dictionary.Test.Factories.DictionaryFactory.Dictionary.Dictionary`2[System.Int32,System.Int32] Create(Int32[], Int32[]) parents=[ 141 142 143 ], inputs=[ (0 0) (1 0) (2 0) ]
plan 32 transformer=(System.Int32)2 parents=[ ], inputs=[ ]
plan 214 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_RemoveContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 191 144 32 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 26 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 896 transformer=Dictionary.Test.DictionaryContractTest.Boolean testFactoryContains(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 214 879 26 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
plan 904 transformer=Dictionary.Test.DictionaryContractTest.Void PUT_ContainsValueContract(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32) parents=[ 896 602 30 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 1280 transformer=Dictionary.Test.DictionaryContractTest.Void testKeySameAsCountAfterAdding(Dictionary.Dictionary`2[System.Int32,System.Int32], Int32, Int32) parents=[ 904 662 31 31 ], inputs=[ (0 0) (1 1) (2 0) (3 0) ]
      */
      //END TEST
