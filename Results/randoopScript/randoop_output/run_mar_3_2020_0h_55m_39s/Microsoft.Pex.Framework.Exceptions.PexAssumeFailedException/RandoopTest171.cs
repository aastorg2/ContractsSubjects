...
public class RandoopTest171
{
  public static int Main()
  {
    try
    {
      ...
      Stack.Stack<System.Int32> v3 = Stack.Test.Factories.StackFactory.Create((System.Int32[])v2) ;
      //Regression assertion (captures the current behavior of the code)
      Assert.IsNotNull(v3);

      ((Stack.Test.StackContractTest)v0).PUT_PopContract((Stack.Stack<System.Int32>)v3) ;
      /*
...
plan 171 transformer=Stack.Test.StackContractTest.Void PUT_PopContract(Stack.Stack`1[System.Int32]) parents=[ 127 108 ], inputs=[ (0 0) (1 1) ]
      */
      //END TEST
