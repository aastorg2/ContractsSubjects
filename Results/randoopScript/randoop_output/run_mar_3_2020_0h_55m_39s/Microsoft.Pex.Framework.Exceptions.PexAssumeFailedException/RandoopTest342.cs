...
public class RandoopTest342
{
  public static int Main()
  {
    try
    {
      ...
      ((Stack.Test.StackContractTest)v0).PUT_PushContract((Stack.Stack<System.Int32>)v21, (System.Int32)v22) ;
      ...
      ((Stack.Test.StackContractTest)v0).PUT_PeekContract((Stack.Stack<System.Int32>)v29) ;
      ...
      ((Stack.Test.StackContractTest)v0).PUT_PushContract((Stack.Stack<System.Int32>)v37, (System.Int32)v38) ;
      System.Int32[] v41 =  new System.Int32[] {};
      Stack.Stack<System.Int32> v42 = Stack.Test.Factories.StackFactory.Create((System.Int32[])v41) ;
      //Regression assertion (captures the current behavior of the code)
      Assert.IsNotNull(v42);

      ((Stack.Test.StackContractTest)v0).PUT_PeekContract((Stack.Stack<System.Int32>)v42) ;
      /*
...
plan 28 transformer=(System.Int32)(-2) parents=[ ], inputs=[ ]
plan 181 transformer=Stack.Test.StackContractTest.Void PUT_PushContract(Stack.Stack`1[System.Int32], Int32) parents=[ 151 138 28 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 112 transformer=array of System.Int32 of length 3 parents=[ 31 34 33 ], inputs=[ (0 0) (1 0) (2 0) ]
...
plan 208 transformer=Stack.Test.StackContractTest.Void PUT_PeekContract(Stack.Stack`1[System.Int32]) parents=[ 181 113 ], inputs=[ (0 0) (1 1) ]
plan 136 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 31 transformer=(System.Int32)1 parents=[ ], inputs=[ ]
plan 30 transformer=(System.Int32)0 parents=[ ], inputs=[ ]
...
plan 138 transformer=Stack.Test.Factories.StackFactory.Stack.Stack`1[System.Int32] Create(Int32[]) parents=[ 136 137 ], inputs=[ (0 0) (1 0) ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 219 transformer=Stack.Test.StackContractTest.Void PUT_PushContract(Stack.Stack`1[System.Int32], Int32) parents=[ 208 138 33 ], inputs=[ (0 0) (1 1) (2 0) ]
...
plan 342 transformer=Stack.Test.StackContractTest.Void PUT_PeekContract(Stack.Stack`1[System.Int32]) parents=[ 219 108 ], inputs=[ (0 0) (1 1) ]
      */
      //END TEST
