...
public class RandoopTest645
{
  public static int Main()
  {
    try
    {
      ...
      ((Stack.Test.StackContractTest)v0).PUT_PopContract((Stack.Stack<System.Int32>)v28) ;
      /*
...
plan 164 transformer=array of System.Int32 of length 1 parents=[ 31 ], inputs=[ (0 0) ]
plan 165 transformer=Stack.Test.Factories.StackFactory.Stack.Stack`1[System.Int32] Create(Int32[]) parents=[ 163 164 ], inputs=[ (0 0) (1 0) ]
plan 276 transformer=Stack.Test.StackContractTest.Void PUT_PeekContract(Stack.Stack`1[System.Int32]) parents=[ 145 165 ], inputs=[ (0 0) (1 1) ]
plan 147 transformer=DummyTransformer parents=[ ], inputs=[ ]
plan 33 transformer=(System.Int32)3 parents=[ ], inputs=[ ]
plan 148 transformer=array of System.Int32 of length 1 parents=[ 33 ], inputs=[ (0 0) ]
plan 149 transformer=Stack.Test.Factories.StackFactory.Stack.Stack`1[System.Int32] Create(Int32[]) parents=[ 147 148 ], inputs=[ (0 0) (1 0) ]
plan 416 transformer=Stack.Test.StackContractTest.Void PUT_PopContract(Stack.Stack`1[System.Int32]) parents=[ 276 149 ], inputs=[ (0 0) (1 1) ]
...
plan 426 transformer=Stack.Test.StackContractTest.Void PUT_PeekContract(Stack.Stack`1[System.Int32]) parents=[ 416 125 ], inputs=[ (0 0) (1 1) ]
...
plan 645 transformer=Stack.Test.StackContractTest.Void PUT_PopContract(Stack.Stack`1[System.Int32]) parents=[ 426 108 ], inputs=[ (0 0) (1 1) ]
      */
      //END TEST
