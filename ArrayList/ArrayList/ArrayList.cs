...
namespace ArrayList
{
    ...
    public class ArrayList : System.Collections.IList, ICloneable
    {
        ...
        public virtual int BinarySearch(int index, int count, Object value, System.Collections.IComparer comparer)
        {
            ...
            //NotpAssume.IsTrue(count >= 0);
            if (count < 0)
                throw new ArgumentOutOfRangeException("nameof(count)", "SR.ArgumentOutOfRange_NeedNonNegNum");
            //NotpAssume.IsTrue(_size - index >= count);
        ...
        {
            //NotpAssume.IsTrue(startIndex <= _size);
            if (startIndex > _size)
        ...
        public virtual int IndexOf(Object value, int startIndex, int count)
        {
            ...
            if (startIndex > _size)
                throw new ArgumentOutOfRangeException("nameof(startIndex)", "SR.ArgumentOutOfRange_Index");
            //NotpAssume.IsTrue(count >= 0 && startIndex <= _size - count);
        ...
        {
            //NotpAssume.IsTrue(Count == 0 || (startIndex >= 0 && count >= 0));
            ...
            //NotpAssume.IsTrue(startIndex < _size && count <= startIndex + 1);
        ...
        private class IListWrapper : ArrayList
        {
            ...
            {
                //NotpAssume.IsTrue(index >= 0 && count >= 0);
                if (index < 0 || count < 0)
                    throw new ArgumentOutOfRangeException(index < 0 ? "nameof(index)" : "nameof(count)", "SR.ArgumentOutOfRange_NeedNonNegNum");
                //NotpAssume.IsTrue(Count - index >= count);
            ...
            public override int LastIndexOf(Object value, int startIndex, int count)
            {
                if (_list.Count == 0)
                    return -1;
                //NotpAssume.IsTrue(startIndex >= 0 && startIndex < _list.Count);
                ...
                //NotpAssume.IsTrue(count >= 0 && count <= startIndex + 1);
            ...
            public override void Reverse(int index, int count)
            {
                ...
                //NotpAssume.IsTrue(_list.Count - index >= count);
                if (_list.Count - index < count)
                    throw new ArgumentException("SR.Argument_InvalidOffLen");
