...
namespace ArrayList.Test
{
    ...
    public partial class ArrayListContractTest
    {
        ...
        public void PUT_GetContract([PexAssumeUnderTest]ArrayList arrList, int index)
        {
            ...
            Assert.True(((New_containsNewRet && Old_index <= Old_arrListCount && (!(Old_index == Old_arrListCount)) && New_arrListCount == Old_arrListCount && Old_index >= 0)));
        }
        ...
        public void PUT_LastIndexOfContract([PexAssumeUnderTest]ArrayList arrList, int x)
        {
            ...
            Assert.True((((!(-1 == Old_arrListCount)) && New_arrListCount == Old_arrListCount && (!(Old_arrListContainsX)) && (!(New_arrListContainsX)) && Old_arrListCount >= -1 && New_Ret == -1 && Old_arrListIndexOfX == -1 && New_arrListIndexOfX == -1) || (New_Ret <= Old_arrListCount && (!(New_Ret == Old_arrListCount)) && Old_arrListIndexOfX <= New_Ret && New_arrListCount == Old_arrListCount && Old_arrListIndexOfX <= New_arrListIndexOfX && New_arrListIndexOfX <= Old_arrListIndexOfX && New_arrListContainsX && Old_arrListContainsX && New_arrListIndexOfX >= 0)));
        }
