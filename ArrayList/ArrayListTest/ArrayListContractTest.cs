...
namespace ArrayList.Test
{
    ...
    public partial class ArrayListContractTest
    {
        ...
        public void PUT_AddContract([PexAssumeUnderTest]ArrayList arrList, int x)
        {
            ...
            Assert.True(((New_arrListContainsX && New_Ret == New_arrListLastIndexOfX && New_arrListCount == 1 + Old_arrListCount && Old_arrListCount <= New_arrListLastIndexOfX && New_arrListLastIndexOfX <= Old_arrListCount && (!(New_arrListLastIndexOfX ==           Old_arrListLastIndexOfX)) && Old_arrListLastIndexOfX <= New_arrListLastIndexOfX && Old_arrListContainsX && New_arrListIndexOfX == Old_arrListIndexOfX && Old_arrListIndexOfX <= Old_arrListLastIndexOfX && Old_arrListIndexOfX >= 0) || (New_arrListContainsX && New_Ret == New_arrListIndexOfX && New_arrListCount == 1 + Old_arrListCount && Old_arrListCount <= New_arrListIndexOfX && New_arrListIndexOfX <= Old_arrListCount && (!(New_arrListIndexOfX == -1)) && (!(Old_arrListContainsX)) && New_arrListLastIndexOfX == New_arrListIndexOfX && New_arrListIndexOfX >= -1 && Old_arrListIndexOfX == -1 && Old_arrListLastIndexOfX == -1)));
        }
        ...
        public void PUT_RemoveContract([PexAssumeUnderTest]ArrayList arrList, int x)
        {
            ...
            Assert.True((((!(-1 == Old_arrListCount)) && Old_arrListIndexOfX <= New_arrListCount && New_arrListCount ==       -1 + Old_arrListCount + -1*Old_arrListIndexOfX && (!(New_arrListContainsX)) && Old_arrListLastIndexOfX == Old_arrListIndexOfX && New_arrListLastIndexOfX == -1 && New_arrListIndexOfX == -1 && Old_arrListIndexOfX >= -1) || (New_arrListCount ==       -1 + Old_arrListCount + -1*Old_arrListIndexOfX && (!(New_arrListCount <= New_arrListIndexOfX)) && New_arrListContainsX && Old_arrListContainsX && Old_arrListIndexOfX <= New_arrListIndexOfX && New_arrListCount == -1 + Old_arrListCount && New_arrListIndexOfX <= Old_arrListIndexOfX && New_arrListLastIndexOfX == -1 + New_arrListCount && Old_arrListLastIndexOfX == New_arrListCount && Old_x <= 0) || (Old_arrListLastIndexOfX <= New_arrListCount && New_arrListCount ==       -1 + Old_arrListCount + -1*Old_arrListIndexOfX && (!(Old_arrListLastIndexOfX <= New_arrListIndexOfX)) && New_arrListContainsX && Old_arrListContainsX && Old_arrListIndexOfX <= New_arrListIndexOfX && New_arrListCount == -1 + Old_arrListCount && New_arrListLastIndexOfX <= Old_x && New_arrListLastIndexOfX ==       -1 + Old_arrListLastIndexOfX && Old_x >= 1) || (New_arrListCount ==       -1 + Old_arrListCount + -1*Old_arrListIndexOfX && (!(New_arrListCount <= New_arrListIndexOfX)) && New_arrListContainsX && Old_arrListContainsX && Old_arrListIndexOfX <= New_arrListIndexOfX && New_arrListCount == -1 + Old_arrListCount && New_arrListLastIndexOfX <= Old_x && New_arrListIndexOfX <= Old_arrListIndexOfX && New_arrListLastIndexOfX == -1 + New_arrListCount && Old_arrListLastIndexOfX == New_arrListCount)));
        }
        ...
        public void PUT_SetContract([PexAssumeUnderTest]ArrayList arrList, int x, int index)
        {
            ...
            Assert.True(((New_arrListContainsX && New_arrListCount <= Old_arrListCount && Old_arrListCount <= New_arrListCount && (!(New_arrListCount <= New_arrListLastIndexOfX)) && New_arrListIndexOfX <= Old_index && Old_index <= New_arrListLastIndexOfX && Old_arrListIndexOfX <= Old_arrListLastIndexOfX && Old_arrListLastIndexOfX <= New_arrListLastIndexOfX && Old_arrListContainsX && (!(Old_x == New_arrListCount)) && New_arrListIndexOfX <= Old_arrListIndexOfX && Old_x >= 0 && New_arrListIndexOfX >= 0) || (New_arrListContainsX && New_arrListCount <= Old_arrListCount && Old_arrListCount <= New_arrListCount && (!(New_arrListCount <= New_arrListLastIndexOfX)) && New_arrListIndexOfX <= Old_index && Old_index <= New_arrListLastIndexOfX && New_arrListLastIndexOfX <= Old_x && (!(Old_arrListContainsX)) && (!(Old_x == Old_arrListCount)) && New_arrListLastIndexOfX <= New_arrListIndexOfX && New_arrListIndexOfX >= 0 && Old_arrListIndexOfX == -1 && Old_arrListLastIndexOfX == -1) || (New_arrListContainsX && New_arrListCount <= Old_arrListCount && Old_arrListCount <= New_arrListCount && (!(New_arrListCount <= New_arrListLastIndexOfX)) && New_arrListIndexOfX <= Old_index && Old_index <= New_arrListLastIndexOfX && (!(Old_arrListContainsX)) && New_arrListLastIndexOfX <= New_arrListIndexOfX && New_arrListLastIndexOfX <= 1 && New_arrListIndexOfX >= 0 && Old_x == 1 && Old_arrListIndexOfX == -1 && Old_arrListLastIndexOfX == -1)));
        }
        ...
        public void PUT_ContainsContract([PexAssumeUnderTest]ArrayList arrList, int x)
        {
            ...
            Assert.True(((New_arrListCount <= Old_arrListCount && Old_arrListCount <= New_arrListCount && (!(New_arrListCount <= New_arrListLastIndexOfX)) && New_arrListLastIndexOfX <= Old_arrListLastIndexOfX && Old_arrListLastIndexOfX <= New_arrListLastIndexOfX && (!(Old_x == New_arrListCount)) && (!(New_arrListLastIndexOfX == Old_x)) && New_Ret && Old_arrListIndexOfX == 0 && Old_x >= 0 && Old_arrListLastIndexOfX >= 1 && New_arrListIndexOfX == 0) || (New_arrListCount <= Old_arrListCount && Old_arrListCount <= New_arrListCount && (!(New_arrListCount <= Old_arrListIndexOfX)) && Old_arrListIndexOfX <= Old_arrListLastIndexOfX && (!(1 == Old_arrListIndexOfX)) && Old_arrListLastIndexOfX <= Old_arrListIndexOfX && New_arrListLastIndexOfX == Old_arrListIndexOfX && Old_arrListIndexOfX == New_arrListIndexOfX && Old_arrListIndexOfX >= -1) || (New_arrListCount <= Old_arrListCount && Old_arrListCount <= New_arrListCount && (!(New_arrListCount <= Old_arrListIndexOfX)) && Old_arrListIndexOfX <= Old_arrListLastIndexOfX && New_Ret && Old_arrListLastIndexOfX <= Old_arrListIndexOfX && New_arrListLastIndexOfX == Old_arrListIndexOfX && Old_arrListIndexOfX == New_arrListIndexOfX && Old_arrListIndexOfX >= -1 && Old_x == 0)));
        }
